        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    html += '@can("delete_employee")<a href="javascript:void(0);" user_id="' + data +
                    ...
                    html +=
                        '&nbsp;@can("update_employee")<a class="btn btn-sm btn-clean btn-icon mr-2" href="javascript:void(0);"><span class="svg-icon svg-icon-md"><img title="Change Password" user_id=' +
                        data +
