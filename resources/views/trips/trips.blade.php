...
<script type="text/javascript">
    $(".trips-nav").click()
    $("#trips_nav").addClass("menu-item-active");
        ...
        table = $('#table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (data == null) {
                            ...
                            var dateTime = row.pickup_date
                            return "<b>Location:</b> " + pickupLocation +
                                "<br><b>Date/Time:</b>" + dateTime;
                        }
                    }
                },
                {
                    ...
                    render: function(data, tye, row) {
                        return "<b>Location:</b>" + data + "<br><b>Date/Time:</b>" + row
                            .delivery_date
                    }
                },
                {
                ...
                },
                {
                    ...
                    width: "250px",
                    render: function(data, tye, row) {
                        return "<b>Name:</b>" + data + "<br><b>Phone:</b>" + row.customer_phone
                    }
                },
                {
                    data: 'stops',
