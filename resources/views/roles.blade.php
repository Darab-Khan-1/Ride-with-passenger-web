    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <form class="form" action="{{ url('/register/role') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                ...
                <form class="form" action="{{ url('/update/role') }}" id="editForm" method="POST"
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-3 col-form-label">{{ __('messages.customer') }}</label>
                                    <div class="col-9 col-form-label">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-success">
                                                <input type="checkbox" name="create_customer" id="create_customer" />
                                                <span></span>
                                                {{ __('messages.add') }}
                                            </label>
                                            <label class="checkbox checkbox-primary">
                                                <input type="checkbox" name="view_customer" id="view_customer" />
                                                <span></span>
                                                {{ __('messages.view') }}
                                            </label>
                                            <label class="checkbox checkbox-info">
                                                <input type="checkbox" name="update_customer" id="update_customer" />
                                                <span></span>
                                                {{ __('messages.update') }}
                                            </label>
                                            <label class="checkbox checkbox-danger">
                                                <input type="checkbox" name="delete_customer" id="delete_customer" />
                                                <span></span>
                                                {{ __('messages.delete') }}
                                            </label>
                                        </div>
...
<div class="modal fade " id="edit_role_Modal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title counter-mirror" id="editModalLabel">{{ __('messages.edit_customer_role') }}
                </h5>
                <button type="button" class="close " data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" id="customer_name"
                                    class="form-control form-control-solid" value="Customer" readonly />
                            </div>
                            <div class="col-md-12 counter-mirror">
                                <div class="form-group row">
                                    <label class="col-3 col-form-label">{{ __('messages.trips') }}</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-form-label">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-success">
                                                <input type="checkbox" name="live_tracking" class="live_tracking" />
                                                <span></span>
                                                {{ __('messages.live_tracking') }}
                                            </label>
                                            <label class="checkbox checkbox-primary">
                                                <input type="checkbox" name="playback" class="playback" />
                                                <span></span>
                                                {{ __('messages.playback') }}
                                            </label>
                                        </div>
            ...
            <div class="card-footer counter-mirror">
                <input type="hidden" name="role_id" id="customer_role_id">
                <button type="submit" class="btn  mr-2"
                    style="background: #ffc500">{{ __('messages.update') }}</button>
                <button type="reset" class="btn btn-secondary"
                    data-dismiss="modal">{{ __('messages.cancel') }}</button>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.name == "Customer") {
                    $("#customer_role_id").val(data.id)
                    $("#customer_name").val(data.name)
                    $("#edit_role_Modal").modal('show');
                    data.permissions.forEach(element => {
                        document.getElementsByName(element.name).forEach(function(
                            checkbox) {
...

            {
                ...
                render: function(data, type, row) {
                    ...
                    if (row.name != "Customer") {
                        html +=
                            '@can('delete_role')<a href="javascript:void(0);" role_id="' +
                            data +
                    ...
                    html += '@can('update_role')<a href="javascript:;" role_id=' +
                        data +
